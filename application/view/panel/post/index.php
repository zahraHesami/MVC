            ...
            <section class="col-md-10 pt-3">
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-">
                        ...
                        <?php
                        global  $pdo;
                        $sql = "SELECT php_project.posts.*, php_project.categorizes.name_cat AS category_name FROM php_project.posts LEFT join php_project.categorizes on php_project.posts.cat_id = php_project.categorizes.id;";
